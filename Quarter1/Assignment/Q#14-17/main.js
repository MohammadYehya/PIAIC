var Invitees = ["Isaac Newton", "Albert Einstein", "Stephen Hawking"];
//Q14
Invitees.forEach(function (Person) { return console.log("Dear " + Person + ", You have been invited to dinner!"); });
...
for (var i = 2; i < Invitees.length;) {
    var Name = Invitees.pop();
