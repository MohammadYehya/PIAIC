...
let database : [string, string, number][] = [["ADMIN", "NIMDA", 100000], ["Mohammad", "abc123", 2000], ["", "000", 0], ["Mohammad", "xyz789", 1000]];
...
Search(database, usr.Username, async (x : [string, string, number]) => {
    while(true)
    {
        clear();
        ...
        switch(choice.val)
        {
            ...
            case 3:
                ...
                else console.log(`Not enough balance in account!\n`);
                await wait();
                break;
        }
